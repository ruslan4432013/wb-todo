...
const commandsMap = {
  ...
  [fullLintCheckCommand]: {
    ...
    value:
      'npx eslint src/ --ext .ts,.js,.tsx,.json --fix --max-warnings=0 --cache --cache-location .eslintinfo && npx stylelint --fix --max-warnings=0 "src/**/*.{modules.scss,scss,css}" --cache --cache-location .stylelintinfo',
  },
};
